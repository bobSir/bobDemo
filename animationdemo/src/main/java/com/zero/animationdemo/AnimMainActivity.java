...
public class AnimMainActivity extends BaseActivity implements OnItemClickListener {
    ...
    public void startIntent(Class class1) {
        Intent intent = new Intent(AnimMainActivity.this, class1);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        switch (position) {
            case 0:
                Intent intent = new Intent(AnimMainActivity.this, SimpleViewAnimation.class);
                startActivity(intent);
                break;
            case 1:
                Intent intent2 = new Intent(AnimMainActivity.this, ComplicateViewAnimation.class);
                startActivity(intent2);
                break;
            case 2:
                Intent intent3 = new Intent(AnimMainActivity.this, SimplePropertyAnimation.class);
                startActivity(intent3);
                break;
            case 3:
                Intent intent4 = new Intent(AnimMainActivity.this, ComplicatePropertyAnimation.class);
                startActivity(intent4);
                break;
            case 4:
                break;
            case 5:
                Intent intent6 = new Intent(AnimMainActivity.this, InterPolatorAnimation.class);
